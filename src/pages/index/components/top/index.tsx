...
const Index=({nav,onChangeNav})=> {
    ...
    return (
        <View className={'top-section'} style={{paddingTop:statusBarHeight+14}}>
            <View className={'nav-bar'} >
                {!nav?<img alt="" src={nav1} className={'navigation-image-one'}/>:<View onTap={()=>onChangeNav(0)}>达人/俱乐部</View>}
                {nav?<img alt="" src={nav2} className={'navigation-image-two'}/>:<View onTap={()=>onChangeNav(1)}>商家</View>}
            </View>
